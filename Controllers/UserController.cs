...
namespace HackDavis2020.Controllers
{
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserID,Username,BluePrintIDs")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserID,Username,BluePrintIDs")] User user)
        {
            if (id != user.UserID)
            {
                return NotFound();
